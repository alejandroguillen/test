...
src/ASN.1/%.o: ../src/ASN.1/%.c
	...
	arm-linux-gnueabihf-gcc -I"/home/alexis/workspace/testcodejordi/src" -I"/home/alexis/workspace/testcodejordi/src/ASN.1" -I"/home/alexis/workspace/testcodejordi/src/MultimediaSystem/includes" -O0 -g3 -Wall -c -fmessage-length=0 -MMD -MP -MF"$(@:%.o=%.d)" -MT"$(@:%.o=%.d)" -o "$@" "$<"
